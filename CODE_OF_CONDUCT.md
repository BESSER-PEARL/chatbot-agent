...
## Need Help?
If ANY behavior makes you uncomfortable, or you believe it breaches the intent of this code of conduct, please contact a project maintainer via the [issue tracker](https://github.com/BESSER-PEARL/chatbot-agent/issues).
...
Instances of abusive, harassing, or otherwise unacceptable behavior may be reported by contacting the project maintainers via the [issue tracker](https://github.com/BESSER-PEARL/chatbot-agent/issues).
...
The structure of this Code of Conduct is based on the short and long version approach inspired by [SustainOSS Code of Conduct](https://sustainoss.org/code-of-conduct/).
