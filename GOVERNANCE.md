...
* [BESSER-PEARL](https://github.com/BESSER-PEARL)
...
2.2. The group of project maintainers will be responsible for assigning labels to issues, as well as assigning the issue to a project maintainer or contributor.
...
3.1. Both collaborators and project maintainers may propose pull requests. When a collaborator proposes a pull request, they are considered a contributor.
